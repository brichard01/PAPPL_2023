...
public class Menu extends javax.swing.JPanel {
   ...
   private ConMail conmail;
    ...
    private void historiqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_historiqueActionPerformed
        ...
        JComboBox annee = ((RechercheHisto)panel.getComponent(0)).getAnnee();
        JComboBox mois1 = ((RechercheHisto)panel.getComponent(0)).getMois1();
        JComboBox mois2 = ((RechercheHisto)panel.getComponent(0)).getMois2();
    ...
    private void actifActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_actifActionPerformed
        ...
        JTable table = ((Actif)panel.getComponent(2)).getjTable1();
    ...
    private void gestionMailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gestionMailActionPerformed
     //  try {
           ...
           JTextField jourAvantR = ((MailRedevable)panel.getComponent(7)).getJourAvantR();
           JTextArea messageAvantR = ((MailRedevable)panel.getComponent(7)).getMessageAvantR();
           JTextField jourApresR = ((MailRedevable)panel.getComponent(7)).getJourApresR();
           JTextArea  messageApresR = ((MailRedevable)panel.getComponent(7)).getMessageApresR();
           conmail=new ConMail();
    ...
    private void gestionAgentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gestionAgentActionPerformed
        ...
        JTable agents = ((Agent)panel.getComponent(6)).getjTable1();
