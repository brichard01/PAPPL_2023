...
public class Creation extends javax.swing.JPanel {
    ...
    ConAgent conAgent = views.Agent.getConAgent();
    ...
    private void initComponents() {
        ...
        nbEcheances.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3"}));
    ...
    private void enregistrerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enregistrerActionPerformed
        try {
            ...
            detSim = concreation.enregistrerRedevable(listeEcheances, mailRedevable, nomRedevable, libelle, montant, infocomplementaire, actionentreprendre, actioneffectuee, listeAgent);
             ...
             int reponse = JOptionPane.showConfirmDialog(this, "Voulez vous générer un document excel ?");
             if(reponse == 0){
