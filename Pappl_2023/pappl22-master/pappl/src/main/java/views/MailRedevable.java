...
public class MailRedevable extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jourAvantR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jourAvantRActionPerformed(evt);
            }
        });
    ...
    private void agentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agentActionPerformed
        ...
        JTextField jourAvantA = ((MailAgent)panel.getComponent(8)).getJourAvantA();
        JTextArea messageAvantA = ((MailAgent)panel.getComponent(8)).getMessageAvantA();
        JTextField jourApresA = ((MailAgent)panel.getComponent(8)).getJourApresA();
        JTextArea  messageApresA = ((MailAgent)panel.getComponent(8)).getMessageApresA();
  ...
  char c=evt.getKeyChar();   
    ...
    private void jourAvantRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jourAvantRActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jourAvantRActionPerformed
