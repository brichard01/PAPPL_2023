...
public class Actif extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nom", "Libellé", "Date création", "Montant dû", "Dette actuelle", "Id", "Numéro d'ordre", "Prochaine échéance"
            }
        ));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       if(evt.getClickCount() == 2){
        JTextField nom = ((DetailAH)panel.getComponent(3)).getNom();
        JTextField libelle = ((DetailAH)panel.getComponent(3)).getLibelle();
        JTextField mail = ((DetailAH)panel.getComponent(3)).getMail();
        JTextField montant = ((DetailAH)panel.getComponent(3)).getMontant();
        JTextField info = ((DetailAH)panel.getComponent(3)).getInfocomplementaire();
        JTextField actionEntre = ((DetailAH)panel.getComponent(3)).getActionentreprendre();
        JTextField actionEffect = ((DetailAH)panel.getComponent(3)).getActioneffectuee();
        JTextField idDette = ((DetailAH)panel.getComponent(3)).getIdDette();
        JTextField agentComptable = ((DetailAH)panel.getComponent(3)).getAgentComptable();
        JTable echeances = ((DetailAH)panel.getComponent(3)).getListeEcheances();
        ...
        ((DetailAH)panel.getComponent(3)).setDetteEnregistre(detteAffiche);
