...
public class DetailAH extends javax.swing.JPanel {
    ...
    private void retournerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_retournerActionPerformed
        JTable tableActif = ((Actif)panel.getComponent(2)).getjTable1();
    ...
    private void editionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editionActionPerformed
        ...
        JTextField libelleE = ((EditionAH)panel.getComponent(4)).getLibelle();
        JTextField mailE = ((EditionAH)panel.getComponent(4)).getMail();
        JTextField montantE = ((EditionAH)panel.getComponent(4)).getMontant();
        JTextField infoE = ((EditionAH)panel.getComponent(4)).getInfocomplementaire();
        JTextField actionEntreE = ((EditionAH)panel.getComponent(4)).getActionentreprendre();
        JTextField actionEffectE = ((EditionAH)panel.getComponent(4)).getActioneffectuee();
        JTextField idDetteE = ((EditionAH)panel.getComponent(4)).getIdDette();
        JTable echeancesE = ((EditionAH)panel.getComponent(4)).getListeEcheances();
        JTextField nomE = ((EditionAH)panel.getComponent(4)).getNom();
        JComboBox agentComptableE = ((EditionAH)panel.getComponent(4)).getAgentComptable();
